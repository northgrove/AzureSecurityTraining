...
## Exercise 5: Microsoft Defender for Cloud Security Alert Analysis Guide
...
### 5.1 Correlate Alerts in Microsoft Defender XDR
...
## Excersise 6: Create more Sample Alerts

To get more insight into different alerts type that can be generated by Defender for Cloud, create Sample Alerts from the Defender for Cloud portal.

1. Goto the Defender for Cloud Portal.

2. Choose "Security Alerts" from the menu to the left

3. on the top bar, click on Sample Alerts. A new sidebar pops up.

![image](../Images/ai/aifoundry13.png)

4. In the "Defender for Cloud plans" drop down list, deselect "Select all" and only select "Ai Services". Click "Create Sample Alerts"

![image](../Images/ai/aifoundry14.png)

5. Take some time to review the different alert types created in the Defender for Cloud portal and in Defender XDR. It Could take a few minutes before the alerts are visible in both portals.


<br>

## Exercise 6: Run Red Team evaluation of your AI Model

### Step 1: Create and run an Evaluation test

1. Change to the new AI Foundry console by toggle the switch in the top right corner in the ai foundry portal.

![image](../Images/ai/new-aifoundry1.png)

2. Click on "build" in top tight corner and choos "Evaluations" fra the left menu. Click Create.

![image](../Images/ai/new-aifoundry2.png)

3. Choose to test a Model, and choos your preferred model to the right. Click Next.

![image](../Images/ai/new-aifoundry3.png)

4. Click "Modify" right to attack strategies, and select your preferred attack strategies to test. Click Save.

![image](../Images/ai/new-aifoundry4.png)
![image](../Images/ai/new-aifoundry5.png)

5. Accept the generated name or type your own name of the evaluation. Click Submit.

![image](../Images/ai/new-aifoundry6.png)

6. Review the result of the evaluation when finnished (could take some minutes). Or review the result of an existing test.

![image](../Images/ai/new-aifoundry7.png)

![image](../Images/ai/new-aifoundry8.png)

![image](../Images/ai/new-aifoundry9.png)

7. If time: Change to content filter on Your model back to Default or from default to a custom filter and rerun the red team evaluation. Is ther any difference of the result?
